...
#-------- DATA -----------#
df = pd.read_csv('../code/datasets/product_info_clean.csv')
content = pd.read_csv('../code/datasets/content_sim.csv')
collab = pd.read_csv('../code/datasets/collaborative_sim.csv')
repurchase = pd.read_csv('../code/datasets/repurchase.csv')
